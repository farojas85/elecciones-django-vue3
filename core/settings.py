...
#SECRET_KEY = 'django-insecure-v#t5a%#dc4*)=o^t7h)6qto+vbvtw6oy(4p59z!3#m00qqc4kq'
...
DATABASES = {
    "default": env.db("DATABASE_URL",default="postgres:///elecciones_adp"),
}
...
if not DEBUG:
    DEFAULT_FROM_EMAIL = 'FarbeSofts <farojas851@gmail.com>'
